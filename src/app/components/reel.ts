...
export class Reel extends PIXI.Container {
    ...
    private static readonly reelMaxSpeed: number = 40;
    ...
    private static readonly totalTiles: number = 7;

    public id: number;
    public tiles: Tile[];
    public currentReelPosition: number = 0;
    ...
    constructor(width: number, height: number, id: number) {
        ...
        for (let i: number = 0; i < Reel.totalTiles; i++) {
            const tile: Tile = new Tile(width, this.tileHeight, id, i);
    ...
    private onComplete(): void {
        ...
        // removes blur filter after sping is complete
        this.filters = null;
    }
